...
final List<Category> categorys =  [
  ...
  Category(categoryId: 2,nameEn: "health",nameJp: "健康"),
  Category(categoryId: 3,nameEn: "science",nameJp: "科学"),
  Category(categoryId: 4,nameEn: "technology",nameJp: "テクノロジー"),
  Category(categoryId: 5,nameEn: "entertainment",nameJp: "エンタメ"),
];